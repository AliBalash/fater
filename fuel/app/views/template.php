            ...
            <div class="col-lg-6">
              ...
              <div class="card" dir="rtl" style="text-align: justify">
                ...
                <div class="card-body">
                  ...
                  <form action="http://fater.local:2080/welcome/login" method="post" enctype="multipart/form-data">
                        <div class="input-group">
                          <input type="text" name="name" placeholder="نام کاربری" class="form-control" required>
